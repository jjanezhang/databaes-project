...
class Purchase:
    def __init__(self, oid, pid, sid, fulfilled, time_fulfilled, price, product_name, time_purchased):
        self.oid = oid
        self.pid = pid
        self.sid = sid
    ...
    def get_all_by_uid_since(uid, since):
        rows = app.db.execute('''
            ...
            P.time_fulfilled AS time_fulfilled, P.price AS price, Pr.name AS product_name, O.time_placed AS time_purchased
